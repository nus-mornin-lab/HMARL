...
def actor(obs, n_h1, n_h2, n_actions):
    ...
    mu = tf.layers.dense(inputs=h2, units=1, activation=None, use_bias=True, name='actor_mean')
    log_sigma = tf.layers.dense(inputs=h2, units=1, activation=None, use_bias=True, name='actor_std')
...
def critic_mixer(obs, actions, single_agent_actions,n_h1, n_h2):
    ...
    h1 = tf.layers.dense(inputs=state_action_single, units=n_h1, activation=tf.nn.relu, use_bias=True, name='V_h1')
...
def critic(obs, actions,n_h1, n_h2):
    ...
    h2 = tf.layers.dense(inputs=h1, units=n_h2, activation=tf.nn.relu, use_bias=True, name='V_h2')
    q = tf.layers.dense(inputs=h2, units=1, activation=None, use_bias=True, name='V_out')
    out = tf.keras.activations.tanh(q)
