...
def run_eval(data, loss, datatype, phase = "train"):
    ...
    res_dir = 'result/hour_4/'+phase+ '/'+ datetime.now().strftime('%Y-%m-%d-%H-%M-%S') + '_' + setting.REWARD_FUN + '_' + datatype +'_' + str(setting.ITERATION_ROUND) + '_' + setting.MODEL + '/'
...
#     plt.xticks(range(-15,20,5))
    ...
    print (q_dr_dt)
    print (conc_dt)
    RLpolicy = data[['stay_id','step_id','mortality_hospital','start','done','reward','iv_fluids_quantile','vasopressors_quantile','Q_0', 'Q_1', 'Q_2', 'Q_3', 'Q_4', 'Q_5', 'Q_6', 'Q_7', 'Q_8', 'Q_9', 'Q_10', 'Q_11', 'Q_12', 'Q_13', 'Q_14', 'Q_15', 'Q_16', 'Q_17','Q_18', 'Q_19', 'Q_20', 'Q_21', 'Q_22', 'Q_23', 'Q_24']]
